...
/**
 * GET /track/my-orders
 * Authenticated user order history by customer_id.
 */
...
/**
 * GET /track/my-orders/:orderNumber
 * Authenticated order detail by customer_id.
 */
exports.trackMyOrder = async (req, res) => {
  try {
    ...
    console.error('trackMyOrder error:', err);
    return res.status(500).json({ success: false, message: 'Internal server error' });
  }
};
